"""Batch runner: 8 pipeline runs in sequence, saving each to zo01x account."""
...
import db
db.init_db()
user_id = db.login_user('zo01x', 'Muha9999!')
print(f"Logged in as zo01x (user_id={user_id})")
...
print(f"\nzo01x total: {len(all_results)} runs, {grand_total} ideas")
